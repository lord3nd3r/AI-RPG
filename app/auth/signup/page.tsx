...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-indigo-600/20 rounded-full blur-[100px] animate-pulse" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-[100px] animate-pulse delay-1000" />

      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-extrabold tracking-tight bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent">
            Join the Guild
          </h1>
          <p className="mt-2 text-slate-400">Begin your legend today</p>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-slate-800 ring-1 ring-white/5">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center pt-4">
              <Link href="/auth/signin" className="text-sm text-indigo-400 hover:text-indigo-300 transition-colors">
